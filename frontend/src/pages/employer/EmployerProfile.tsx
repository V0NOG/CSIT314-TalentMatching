...
export default function EmployerProfile() {
  ...
  const handleCancelMembership = async () => {
    if (!user) return;
    if (!window.confirm("Cancel your Premium membership? You'll lose unlimited candidate recommendations at the end of this billing period.")) return;
              ...
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5 mb-4">
                    Free accounts show up to 10 candidate recommendations per job posting. Upgrade to Premium
                    for unlimited matches, deeper scoring details, and priority employer visibility.
                  </p>
                  <ul className="space-y-1.5 mb-4">
                    {["Unlimited candidate recommendations per job", "Full match score breakdowns", "Priority employer listing"].map((f) => (
